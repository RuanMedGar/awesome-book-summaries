	  ...
	  collapsed:: true
		...
		- Distribuição trimodal do trauma
		  Essa distribuição é usada como indicador de qualidade do atendimento ao trauma.
			- Minutos a segundos
			  Mortes rápidas. Só se pode atuar na prevenção
				- Apneia por lesão neurológica
				- Ruptura dos grandes vasos
			- Minutos a horas
			  É a hora de ouro. Chance de intervenções efetivas
				- Hematoma subdural ou epidural. Hemopneumotorax, Ruptura de baço, lacerações hepáticas, fraturas pélvicas, hemorragias
			- Dias a semanas
			  As etapas precedentes têm grande impacto nesta última.
				- Sepse, disfunção de múltiplos órgãos e sistemas
	- ## Modelos propostos para centros de trauma
	  collapsed:: true
		- Modelo exclusivo:
		  Ideal, muito resolutivo, mas muito caro.
		- Modelo inclusivo:
		  O mais comum por ser mais barato e melhor que o modelo antigo que não tinha qualquer organização.
	- ## Anamnese comum X Anamnese no trauma
	  collapsed:: true
		- Princípios
			- Tratar primeiro a maior ameaça.
			- Não esperar diagnóstico definitivo. Tratar mais precocemente.
			- Historia detalhada não é essencial. Não deve impedir o início das intervenções.
		- Seguir a ordem do que mata ABCDE
- # 1 - Avaliação e atendimento iniciais
  collapsed:: true
  id:: 6307bf18-0f90-4559-959f-cccf9bc264c7
	- Avaliação rápida e terapia de preservação da vida.
	- ## Preparação
		- Fase pré-hospitalar
			- Informar ao hospital de referência antes de realizar o transporte.
			- Garantir permeabilidade de via aérea, controle de sangramento externo e choque.
			- Imobilização do paciente e transporte imediato
		- Fase hospitalar
			- Se prepara para receber o caso avaliando conjuntamente com o pré-hospitalar, preparando a equipe, o ambiente e o material.
	- ## Triagem
		- Classificar doentes considerando o tratamento necessário e os recursos disponíveis
		- ABC
		- Gravidade da lesão, probabilidade de sobrevida e recursos disponíveis
		- Determinar o serviço capaz de receber o paciente
		- Severidade dos eventos
			- Múltiplas vítimas
			  Número de doentes e gravidade da lesão inferiores à capacidade hospitalar
			  Priorizar os mais graves, com morte iminente ou traumatismos multissistêmicos.
			- Vítimas em massa
			  Hospital não comporta todos e o nível de gravidade. Socorrer aqueles com maior chance de sobrevida primeiro.
- # 2 - Tratamento da via aérea e da ventilação
  collapsed:: true
	- Hipóxia é a primeira e mais rápida causa de morte no trauma
	...
	- ## Ventilação
	  Garantir patência da via aérea somente não garante oxigenação
		...
		- Tratamento da via aérea
			...
			- Antecipe via aérea difícil
				- Fatores complicadores
					- Lesão cervical
					- Artrite da cervical
					- Trauma maxilofacial ou mandibular
		...
		- Controle de Oxigenação
			...
			- Oximetria não dá certo sem perfusão e nem em paciente intoxicados por monóxido de carbono. Também não é confiável em anemia profunda ou hipotermia.
  ...
  collapsed:: true
	...
	- Choque Hemorrágico
	  ...
	  Causa mais comum de choque no trauma
		...
		- Classificação da hemorragia
			...
			- Tabela de classificação da hemorragia
	...
	- Abordagem inicial do choque hemorrágico
	  collapsed:: true
		...
		- Reposição volêmica inicial
			...
			- Nesses casos, manter PA ligeiramente abaixo do normal - reanimação controlada, hipotensão permissiva
	...
	- Reposição de sangue
	  ...
	  Respondedores transitórios ou não respondedores necessitam de hemotransfusão com concentrado de hemácias, plasma e plaquetas
		...
		- Reposição de cálcio
			- A maior parte dos doentes que recebem hemoderivados não necessitam de cálcio.
	  ...
	  Os problemas devem ser corrigidos assim que identificados
		- Problemas de via aérea
			...
			- Lesão de árvore traqueobrônquica
				...
				- Após passagem do dreno, expansão pulmonar incompleta ou fístula aérea de alto débito sugerem esse tipo de lesão.
		...
		- Problemas de circulação
		  AESP é um sinal comum. Avalie presença de cianose e turgência jugular. Ouça a regularidade e a qualidade das bulhas cardíacas. Avalie o pulso central. Palpe a pele para avaliar sudorese. Avalie a pressão arterial e de pulso. Monitore com ECG e oximetria.
			- Hemitórax maciço
				...
				- Alguns doentes, mesmo sem hemotórax maciço, necessitam de toracotomia, caso seu estado fisiológico não melhore e continue drenando sangue.
		...
		- Lesões torácicas potencialmente letais
		  Lesões menos óbvias ou imediatas, mas que também matam.
			...
			- Contusão pulmonar
				...
				- Bloqueio intermitente do nervo intercostal. Anestesia percutânea intrapleural, extrapleural ou epidural. Evite sedação, se possível.
...
- # 5 - Trauma Abdominal e Pélvico
  ...
  id:: 6307bf17-0965-40d1-ac0a-ccdb2dc993df
	- Introdução
		...
		- Sangramentos abdominais podem ocorrer sem sinais externos, aumento do volume ou irritação abdominais.
	  ...
	  Em pacientes hipotensos, avaliar se há sangramento abdominal e se essa é a causa. Pacientes normotensos, sem sinais de peritonite, têm risco de complicações mais tardias. Deve-se avaliar mais de uma vez.
		...
		- Exame físico
		  Documentar achados para comparar com reavaliação
			- Inspeção, Ausculta, Percussão e Palpação
				...
				- Após o exame, cubra o paciente para evitar hipotermia.
		...
		- Complementos do Exame Físico
			...
			- LPD
				...
				- Indica laparotomia se encontrado conteúdo gastrointestinal, fibras vegetais, mais de 10 ml de sangue ou bile.
...
- # 6 - Trauma Cranioencefálico
  ...
  id:: 6307bf17-8a86-40f8-90a9-eaa1146dfa85
	  ...
	  collapsed:: true
		...
		- Meninges
			...
			- Aracnoide
				...
				- Fina e transparente
				- Não é aderida à dura-mater, formando um espaço virtual chamado subdural
	  ...
	  collapsed:: true
		...
		- TCE Moderado - Glasgow de 09 a 13
		  ...
		  collapsed:: true
			...
			- Repetir TC na alta
		- TCE grave - Glasgow igual ou menor que 08
	...
	- Prognóstico
	  collapsed:: true
		- Trate agressivamente e transporte para neurocirurgia o quanto antes que você melhora o prognóstico
	- Morte encefálica
	  collapsed:: true
		- Critérios
			- Glasgow = 3
	  ...
	  collapsed:: true
		...
		- Anatomia da medula espinhal
		  collapsed:: true
			...
			- Se um paciente se apresenta sem função motora e sensitiva a partir de um nível, diz-se que houve lesão completa. Se há certo grau de motricidade ou sensibilidade, diz-se incompleta.
		- Dermátomos
		  collapsed:: true
		...
		- Normas de triagem
		  collapsed:: true
			...
			- Coluna Toracolombar
				...
				- Acordados, alertas, sem dor e etc, provavelmente não precisam de imagem
	  ...
	  Hemorragia e exanguinação são a prioridade. Reconheça fraturas de ossos longos.
		- Hemorragia arterial grave e amputação traumática
		  collapsed:: true
			...
			- Avaliação em todas as extremidades
			  collapsed:: true
				- Hemorragia aparente
	  ...
	  collapsed:: true
		- História
		  collapsed:: true
			- Mecanismo de trauma
			  collapsed:: true
				- Reconstruir mentalmente a cena do trauma
		  ...
		  collapsed:: true
			...
			- Indicações de IOT precoce em queimados
			  collapsed:: true
				...
				- Necessidade de transporte sem pessoal que possa intubá-lo no transporte
		...
		- Exames básicos para doentes com queimaduras graves
		  collapsed:: true
			- Laboratório
			  collapsed:: true
				- Hemograma
				- Tipo sanguíneo e prova cruzada
				- HbCO
				- Glicemia
				- Eletrólitos
				- Beta-HCG
				- Gasometria
			- Radiografia de tórax se IOT ou suspeita de inalação
		- Circulação periférica em queimaduras circunferenciais de extremidades
		  collapsed:: true
			- Avalie síndrome compartimental
			- A pressão no compartimento aumenta em relação à PA sistólica, causando má perfusão e necrose
			- O pulso some quando a pressão compartimental fica igual ou maior que a sistólica, mas esse é um achado muito tardio
			- Apresenta-se como dor desproporcional ao estímulo, dor ao estiramento passivo do músculo, edema tenso, parestesia e alteração da sensibilidade.
			- Síndrome compartimental torácica ou abdominal podem ocorrer em lesões circunferenciais - Escarotomia
			- Mantenha a circulação em queimaduras circunferenciais
			  collapsed:: true
				- Remova todos os adereços
				- Observe enchimento capilar, cianose e comprometimento neurológico progressivo. Avalie pulsos com doppler
				- Escarotomia se necessário
				- Fasciotomia é raro, mas fazer se necessário
				- Escarotomias geralmente são feitas na pele queimada
		- Sondagem gástrica
			- Indicada se sinais gastrointestinais ou se queimadura maior que 20%
			- Passe antes de transferir
		- Narcóticos, analgésicos e sedativos
			- Agitação não é só dor, pode ser hipovolemia ou hipóxia. Suplemente O2 e volume primeiro.
			- Precisando de fármacos, faça pequenas doses frequentes EV
			- Cubra a queimadura com gaze estéril úmida, mas cuidado com hipotermia.
		- Cuidados com a ferida
			- Cubra-a.
			- Não rompa bolhas
			- Não aplique antissépticos
			- Remova qualquer coisa que tenha sido posta em cima
			- Aplique ATB tópico
			- Limpe com soro estéril
		- Antibióticos
			- Não faça profilaxia
			- Só use se sinais de infecção
		- Imunização do tétano
			- Investigue e atualize
	- Lesões causadas por queimaduras específicas
	  collapsed:: true
		- Queimaduras químicas
		  collapsed:: true
			- Exposição a ácidos, álcalis ou derivados de petróleo
			- Necrose de coagulação
			- Álcali penetra mais profundo, queimaduras mais graves
			- Remoção do produto química imediata. Se for pó seco, escove antes de irrigar
			- Irrigação local com água aquecida por 30 minutos com uma ducha. Em álcalis, irrigue por mais tempo.
			- Agentes neutralizantes não são legais pois a reação libera calor
			- Alcalis nos olhos = irrigação por 8 horas
			- Identifique o produto químico
			- Cuidado pra não se queimar também!
		- Queimaduras elétricas
		  collapsed:: true
			- Corpo funciona como condutor e sofre lesão térmica
			- São mais graves do que parecem à inspeção. Pele normal mas tecidos profundos necrosando
			- Dedos sofrem especialmente.
			- Propensão à trombose e lesão dos nervos.
			- Contraturas, grande incidência de necessidade de fasciotomia
			- Tratamento
				- Via aérea, respiração, acesso venoso, monitorar ECG e sondagem vesical
				- Atenção para arritmias e PCR
				- Monitorizar ECG em pacientes com lesão de queimadura visível, RNC, exposição a alta tensão e arritmias
				- Procure lesões musculoesqueléticas, em especial, vertebrais.
				- Reanimação volêmica dobrada - 4 ml/kg/%ACSQ - garantindo 100 ml/h de diurese. Urina clara, diminui fluxo.
		- Queimaduras causadas por piche quente
		  collapsed:: true
			- Adere e é muito quente
			- Resfriar o mais rápido possível
			- Evitar trauma adicional quando for remover
			- óleo mineral pode dissolver o piche
		- Queimaduras que indicam maus tratos
		  collapsed:: true
			- Pode ocorrer tanto em crianças quanto adultos
			- Extremos de idade são as maiores vítimas
			- Dissociações entre o mecanismo referido e a lesão
			- Queimaduras circulares , bordas claras ou com mesmo padrão
			- Queimaduras nos pés, bilaterais, poupando ou não a face plantar
			- Face posterior das nádegas e pernas
			- Queimaduras antigas + nova lesão traumática
	- Transferência de doentes
	  collapsed:: true
		- Critérios de transferência para unidade de queimados
		  collapsed:: true
			- Espessura parcial acima de 10%
			...
			- Queimadura + trauma concomitante
			- Crianças queimadas, se capacidade técnica local não estiver preparada
			- Necessidade de suporte especial, social ou psicológico
			- PS: pode haver plano terapêutico compartilhado, que evite necessidade de transferência
	  ...
	  collapsed:: true
		- Tipos de lesão por frio
		  collapsed:: true
			- Congelamento
			  collapsed:: true
				- Formação de cristais de gelo causando anóxia
				- Lesão de reperfusão no reaquecimento
				- Lesão inicial endurecida, fria, pálida e anestesiada muda para outro padrão indicando a profundidade
				- Classificação em 4 graus
				  collapsed:: true
					- Primeiro grau: Hiperemia e edema, sem necrose
					- Segundo grau: Formação de vesícula, clara, hiperemia e edema com necrose de espessura parcial
					- Terceiro grau: Necrose do subcutâneo, espessura total. Comum vesículas hemorrágicas
					- Quarto grau: Espessura total, músculo e isso, com necrose posterior.
					-
				- Avaliação cirúrgica após demarcação dos limites da lesão, o que pode demorar meses.
			- Lesão não congelante
			  collapsed:: true
				- Comprometimento microvascular, estase
				- Exposição crônica a temperaturas pouco acima do ponto de congelamento
				- Pode não haver destruição de estruturas profundas
				- Inicialmente frio e anestesiados, evoluindo para hiperemia com intensa dor e disestesia, edema, bolhas, equimoses e ulcerações.
				- Favorecem surgimento de infecção local
		- Tratamento do congelamento e das lesões não congelantes
		  collapsed:: true
			- Cuidados gerais
				- Não reaquecer se houver risco de novo congelamento
				- Roupas quentes. Comida quente por via oral, se possível.
				- Imersão em água circulante a 40 graus C até retorno da perfusão e coloração rosada
				- Evite calor seco, esfregar ou massagear área afetada
				- Reaquecimento é extremamente doloroso, use analgesia apropriada.
				- Monitore ECG
				- Síndrome de reperfusão pode levar a acidose, hipercalemia e edema.
			- Cuidados locais no congelamento
				- Tentar ao máximo preservar tecido e evitar infecções
				- Eleve o membro
				- Não estoure vesículas não-infectadas
				- Proteger com tenda para evitar pressão
				- Reaquecimento passivo x Reaquecimento ativo
				  collapsed:: true
					- Passivo: deixar a termorregulação agir em um ambiente aquecido. Roupas, cobertores.
					- Ativo: Fornecer fontes de calor adicionais. Fluidos aquecidos, almofadas aquecidas.
				- Profilaxia antitetânica
				- ATB só se infecção
				- Evitar vasoconstritores
				- Restrição de atividades físicas
				- Desbridamento ou cirurgia só após demarcação da lesão ou infecção associada.
				- Vasodilatadores, heparinização e oxigenoterapia hiperbárica não têm evidência
	- Lesões por frio: Hipotermia sistêmica
	  collapsed:: true
		- Qualquer grau de hipotermia é danoso
		- Hipotermia é temperatura menor ou igual que 36. Abaixo de 32 é hipotermia grave.
		- Fluidos ou sangue aquecido, aquecimento do ambiente e cobertura corporal.
	- Trabalho em equipe
		- Reconhecer aspectos específico das lesões térmicas
		- Limitar a exposição do paciente
- # 10 - Trauma Pediátrico
  collapsed:: true
	- Introdução
		- Trauma é a primeira causa morbimortalidade
	- Tipos e padrões de lesões
		- Acidentes de trânsito, afogamento, incêndios, homicídios e quedas
		- Maus tratos são primeira causa de homicídio em lactentes
		- Quedas são muito comuns, mas geralmente não causam morte
		- Politruma é a regra da faixa etária, em detrimento de lesão única
		- Poucas crianças ficam graves, mas quando deteriora, é rápido.
		- Transferir o mais rápido possível
		- Escore de trauma pediátrico
		- |Componente|+2|+1|-1|
		  |--|--|--|--|
		  |Peso|> 20 kg|10 a 20 kg|< 10 kg|
		  |Via aérea|Normal|Cânula oro ou nasofaríngea[:br]Oxigênio|Intubadi, cricotireoideotomia ou traqueostomia|
		  |Pressão sistólica|>90 mmHg [:br]Pulsos e perfusão periférica|50 a 90 mmHg[:br]Pulsos carotídeos ou femorais palpáveis|< 50 mmHg[:br]Pulsos fracos ou ausentes|
		  |Nível de consciência|Alerta|Obnubilado ou qualquer perda de consciência|Coma, sem resposta|
		  |Fratura|Ausentes e sem suspeita|única, fechada|Exposta ou múltipla|
		  |Lesões cutâneas|Ausentes|Contusão, abrasão, laceração <7 cm sem comprometer fáscia|Perda de tecido ou qualquer orifício relacionado a arma de fogo ou arma branca que ultrapassa a fáscia|
	- Características próprias dos doentes pediátricos
	  collapsed:: true
	  Seguir o ABCDE tendo em vista particularidades. A via aérea tem evidência ainda maior que no adulto.
		- Tamanho, forma e área de superfície corporal
		  collapsed:: true
			- Menor massa corporal = traumas maiores com a mesma energia
			- Corpo com menos gordura e tecido conjuntivo, mais fácil de chegar em um órgão
			- Cabeça maior, mais chance de lesão cerebral
			- Corpo menor, hipotermia é mais relevante
		- Esqueleto
		  collapsed:: true
			- Calcificação incompleta, mais flexível
			- Lesões de órgãos internos sem fratura
			- Fratura significa transferência macica de energia
		- Status psicológico
		  collapsed:: true
			- Capacidade limitada de interação com estranhos atrapalha história clínica
			- Baixa cooperação a intervenções
		- Efeitos a longo prazo
		  collapsed:: true
			- O trauma pode deixar sequelas importantes para o crescimento e desenvolvimento
			- Limitações físicas e neurológicas subsequêntes
			- Atente para lesões ósseas e intra-abdominais
			- Exames de imagem aumentam risco de neoplasia. Indicação estrita
			  collapsed:: true
				- Informação não pode ser obtida por outros meios
				- Informação muda o tratamento
				- Mínimo de radiação possível
				- Não atrasa o tratamento definitivo
		- Equipamento
		  collapsed:: true
			- Fita baseada no cumprimento ajuda a determinar peso
			- Equipamento no tamanho adequado
			- Drogas na dose adequada por peso corporal
			- Equipamento pediátrico para via aérea
			  |Idade e Peso|Máscara de O2|Sonda[:br]Orotraqueal|Bolsa Máscara|Laringoscópio|Tubo ET|Guia|Sonda aspiração|
			  |--|--|--|--|--|--|--|--|
			  |RNTP[:br]3 kg|RNTP, RN|Lactente|Lactente|0 reto|2.5 - 3.0 s/ balonete|6 Fr|6 - 8 Fr|
			  |0-6 m[:br]3.5 kg|RN|Lactente, Pequena|Lactente|1 reto|3.0 - 3.5 s/ balonete|6 Fr|8 Fr|
			  |6-12 m[:br]7 kg|Pediátrica|Pequena|Pediátrica|1 reto|3.5 - 4.0 s/ balonete|6 Fr|8 - 10 Fr|
			  |1-3 a[:br]10-12 kg|Pediátrica|Pequena|Pediátrica|1 reto|4.0 - 4.5 c/ ou s/ balonete|6 Fr|10 Fr|
			  |4-7 a[:br]16-18 kg|Pediátrica|Média|Pediátrica|2 reto e curvo|5.0 - 5.5 c/ balonete|14 Fr|14 Fr|
			  |8-10[:br]24-30 kg|Adulto|Média, grande|Pediátrica, Adulto|2-3 reto e curvo|5.5 - 6.5 c/ balonete|14 Fr|14 Fr|
			- Equipamento pediátrico para circulação
			  |Peso e idade|Manguito|Catéter EV|
			  |--|--|--|
			  |RNTP[:br]3 kg|RNTP, RN|22-24 ga|
			  |0-6 m[:br]3.5 kg|RN, Lactente|22 ga|
			  |6-12 m[:br]7 kg|Lactente, Pediátrica|22 ga|
			  |1-3 a[:br]10-12 kg|Pediátrica|20 - 22 ga|
			  | 4-7 a[:br]16-18 kg|Pediátrica|20 ga|
			  |8-10 a[:br]24-30 kg|Pediátrica, Adulto|18 ga|
			- Equipamento pediátrico complementar
			  |Peso e idade|Tubo OG, NG|Dreno de Tórax|Catéter urinário|Colar cervical|
			  |--|--|--|--|--|
			  |RNTP[:br]3 kg|8 Fr|10-14 Fr|5 Fr|-|
			  |0-6 m[:br]3.5 kg|10 Fr|12-18 Fr|6 Fr ou 5-8 Fr|-|
			  |6-12 m[:br]7 kg|12 Fr|14-20 Fr|8 Fr|Pequeno|
			  |1-3 a[:br]10-12 kg|12 Fr|14-24 Fr|10 Fr|Pequeno|
			  |4-7 a[:br]16-18 kg|12 Fr|20-28 Fr|10-12 Fr|Médio|
			  |8-10 a[:br]24-30 kg|14 Fr|28-32 Fr|12 Fr|Médio|
	- Via aérea
	  collapsed:: true
		- Anatomia
		  collapsed:: true
			- Plano da face em paralelo ao chão, posição do cheirador não é útil em crianças
			- Crianças até 3 anos se beneficiam de coxim de 2.5 cm no dorso
			- Traqueia curta, cuidado com intubação seletiva
			- Tubo deve progredir 3x a sua numeração
		- Abordagem
			- Orientações
			  collapsed:: true
				- Manter face em plano paralelo ao chão ou maca
				- Manter alinhamento neutro da coluna
				- Elevação da mandíbula + imobilização bimanual cervical
				- Aspiração, retirada de corpo estranho e oxigênio suplementar
				- Pre-oxigenar antes de via aérea mecânica
			- Cânula orofaríngea
			  collapsed:: true
				- Deve estar insconsciente
				- Curvatura para baixo desde o início, ajuda um abaixador de língua
			- Intubação orotraqueal
			  collapsed:: true
				- Indicações
				  collapsed:: true
					- TCE grave que precisa de ventilação
					- Proteger via aérea
					- Insuficiência respiratória
					- Hipovolemia profunda, RNC ou pré-cirúrgico
				- Anel cricoide se torna selo natural, substituindo balonete
				- Novos tubos com balonete adequados para criança
				- Manter pressão do cuff < 30 mmHg
				- Fitas de emergência já mostram tamanho do tubo. Mas tenha um tubo numero acima e outro abaixo também.
				- Se usar fio-guia, ponta não pode ultrapassar ponta do tubo
				- Lactentes têm reflexo vagal maior, podendo ter bradicardia só pela laringoscopia
				- Sulfato de atropina 0,1 a 0,5 mg profilático em lactentes menores que 1 ano
				- Após passagem, chegar posicionamento do tubo. 2 a 3 cm abaixo das cordas vocais e 3x o tamanho distante da gengiva.
				- Traqueia curta, qualquer movimento desloca o tubo. Auscultar periodicamente.
				- DOPE - Causas comuns de piora em pacientes intubados
					- Deslocamento
					- Obstrução
					- Pneumotórax
					- Equipamento
			- Cricotireoidostomia
				...
				- Rara em crianças menores por difícil palpação
				- A partir de 12 anos é mais fácil
	- Respiração
	  collapsed:: true
		- Respiração e ventilação
			- Frequência respiratória diminui com o crescimento
				- Lactente - 30 a 40 ipm
				- Criança maior - 15 a 20 ipm
			- Volume corrente entre 4 e 6 mL/kg, podendo ser necessário até 10 ml/kg em VM
			- Imaturidade dos alvéolos - Maior risco de barotrauma.
			- Usar DBVM - AMBU específico para crianças menores que 30 kg. Usar o de adulto em criança é a receita do barotrauma.
			- Crianças fazem mais acidose respiratória. Corrigir com bicarbonato enquanto não garante ventilação piora.
		- Punção e drenagem pleural
			- Toracocentese descompressiva acima do terceiro arco costal, na linha hemiclavicular
			- Em crianças, prefira cateteres menores que 14 gauge.
			- Drenagem em quinto espaço intercostal, entre linha axilar  e média, igual no adulto.
			- Drenos de tórax também devem ser menores.
	- Circulação e choque
	  collapsed:: true
		- Reconhecimento de alteração circulatória
		  collapsed:: true
			- Maior reserva funcional
			- Choque mais sutil, sem tanta diminuição da PA. Não espere a hipotensão.
			- Taquicardia e diminuição da perfusão já podem ser choque. Diminuição progressiva dos pulsos periféricos, pinçamento da pressão de pulso em menos de 20 mmHg. Diminuição do turgor. Extremidades frias. RNC.
			- Monitore PA e diurese
			- PAS normal = 90 + 2x idade. Limite inferior é 70 + 2x idade. PAD = 2/3 da PAS
			- Sinais Vitais normais pediátricos
			  |Idade|Peso|FC|PA|FR|Débito urinário[:br]mL/kg/h|
			  |--|--|--|--|--|--|
			  |Lactente[:br]0-12 m|0-10|<160|>60|<60|2.0|
			  |Lactente[:br]1-2 a|10-14|<150|>70|<40|1.5|
			  |Pré-escolar[:br]3-5 a|14-18|<140|>75|<35|1.0|
			  |Escolar[:br]6-12 a|18-36|<120|>80|<30|1.0|
			  |Adolescente[:br]>= 13 a|36-70|<100|>90|<30|0.5|
		- Determinação do peso e volemia
		  collapsed:: true
			- Pergunte ao responsável
			- Fita baseada em tamanho
			- Peso = 2x idade + 10
			- Volume circulatório estimado
			  collapsed:: true
				- 80 mL/kg até 1 ano
				- 75 mL/kg entre 1 e 3 anos
				- 70 mL/kg acima de 3 anos
		- Acesso venoso
		  collapsed:: true
			- Desafiador em crianças com choque
			- Punção periférica (duas tentativas)
				- Fossa antecubital, veias safena no tornozelo
			- Punção intraóssea com agulha de punção de medula óssea
				- Tibia anteromedial
				- Fêmur distal
				- Não realizar em extremidade com fratura
			- Punção femoral por técnica de seldinger
			- Dissecção venosa como último recurso
				- Veia safena do tornozelo
		- Ressuscitação volêmica e de hemocomponentes
		  collapsed:: true
			- Meta baseada no peso
			- Se hemocomponentes disponíveis - Solução cristaloide aquecida 20 mL/kg em bólus + 10 a 20 mL/kg de concentrado de hemácias + 10 a 20 mL/kg de plasma fresco congelado + plaquetas
			- Se hemocomponentes indisponíveis - Solução cristaloide aquecida 20 mL/kg em bólus
			...
			- Resposta à ressuscitação
			  collapsed:: true
				...
				- Resposta transitória
				- Não-responsivo
				- Nos dois últimos, protocolo de transfusão maciça e cirurgia imediata
		- Diurese
			- Avaliar reposição volêmica
			- Sondagem vesical
		- Termoregulação
			- Evite hipotermia com aquecedores, cobertores e líquidos aquecidos
	- Reanimação cardiopulmonar
	  collapsed:: true
		- Alta taxa de retorno sem sequelas
		- Mais de 15 minutos de ressuscitação e pupilas fixas são mau prognóstico.
	- Trauma torácico
	  collapsed:: true
	  id:: 6307bf16-21b1-4157-be18-7c87ceafd085
		- Trauma torácico em crianças é incomum, geralmente indica politrauma
		- Mais facilidade de atingir o parênquima pulmonar
		- Fraturas não são comuns, mas indicam grande transferência de energia
		- Pneumotórax hipertensivo é ainda mais grave em crianças
		- Pneumomediastino costuma ser benigno
		- Lesões torácicas graves geralmente se associam a outras lesões graves
		- Radiografia de tórax é mais útil que TC em crianças
	- Trauma abdominal
	  collapsed:: true
	  id:: 6307bf16-df05-467d-b5ee-99bc8b19fed1
		- Avaliação
		  collapsed:: true
			- As crianças vão estar agitadas, tente ter uma conversa calma para colher a história
			- Pergunte se há dor abdominal e palpe abdome gentilmente. Evite a palpação profunda
			- Sonda gástrica pode ajudar a diminuir distensão. Orogástrica para os lactentes.
			- Marca do cinto aumenta chances de lesão abdominal
			- Avaliar necessidade de sonda vesical
		- Métodos diagnósticos auxiliares
		  collapsed:: true
			- TC
				- Não deve atrasar
				- Indicada em pacientes estáveis
				- Criança geralmente precisa de sedação
				- Maior incidência de neoplasia, use somente se necessário, cortes menores e menos radiação.
			- FAST
				- Pouco sensível em crianças, não se deve confiar nele para excluir lesões.
				- Achou líquido livre e criança estável, TC
			- LPD
				- Quando houver instabilidade e não for possível obter TC ou FAST
				- Achado de sangue em criança estável não necessariamente indica cirurgia
				- Só deve ser feita pelo cirurgião que irá fazer o tratamento definitivo
		- Tratamento não operatório
		  collapsed:: true
			- Achados da TC e FAST não necessariamente indicam laparotomia.
			- A estabilidade do doente é o fator mais importante pois crianças geralmente têm sangramento abdominal autolimitado
			- Se instável e exame com sinais de sangramento, laparotomia imediata.
			- Só optar por medida conservadora nos casos e centros em que se pode observar o doente e realizar laparotomia prontamente se necessário
		- Lesões viscerais específicas
		  collapsed:: true
			- Lesões de alça de delgado próximas ao ligamento de Treitz, lesões mesentéricas e avulsões de alças são mais comuns em crianças
			- Ruptura de bexiga também é mais comum
			- Achado de marca de cinto de 2 pontas indica lesão abdominal, até que se prove o contrário
			- Proximidade do períneo com o peritônio aumenta a chance de lesão perfurante
			- Qualquer lesão de víscera oca exige cirurgia imediata
	- Traumatismo caranioencefalico
	  collapsed:: true
		- Diferenças
		  collapsed:: true
			- Cérebro menor
			- Espaço subaracnoide menor, oferecendo menos poroteção
			- Fluxo cerebral dobrado próximo aos 5 anos de idade
			- Maior fragilidade à hipóxia e hipercarbia
		- Avaliação
		  collapsed:: true
			- Melhor prognóstico de TCE em crianças, mas pior abaixo de 3 anos.
			- Mais susceptibilidade ao choque
			- Fontanelas e suturas abertas
				- mais volume sanguíneo nos espaços subgaleal, intraventricular e epidural
				- Maior tolerância ao efeito de massa. Atraso no início dos sinais clínicos
				- Lactente com abaulamento da fontanela ou diátese das suturas deve ser tratado como TCE grave, apesar do nível de consciência
				- Vômitos e amnésia mais comuns, mesmo sem efeito de massa. Vômitos persistentes merecem TC de crânio
				- Convulsões logo após o trauma são comuns e geralmente autolimitadas
				- Menos lesões focais, mas hipertensão intracraniana mais comum.
				- Escala de coma de glasgow modificada para idade menor que 4 anos
				  |Resposta Verbal|Escore|
				  |--|--|
				  |Palavras apropriadas, sorriso social, fixa e segue o olhar|5|
				  |Chora, mas consolável|4|
				  |Persistentemente irritado|3|
				  |Agitado, inconsolável|2|
				  |Ausente|1|
				- Monitorização de pressão intracraniana precoce
				  collapsed:: true
					- Glasgow 8 ou escore motor de 1 ou 2
					- Politrauma + TCE - especialmente se necessitam de reposição volêmica maciça, cirurgia torácica ou abdominal imediata ou tenham avaliação e estabilização prolongadas
					- Sinais de hemorragia cerebral, edema, cerebral ou herniação
				- Drogas com ação neurológica devem ser avaliadas em conjunto com o neurocirurgião
		- Tratamento
			- ABCDE
			- Prevenção de hipóxia e hipoperfusão
			- Solução salina ou manitol se PIC elevada
			- Reavaliação contínua
			- Avaliação cirúrgica precoce
	- Traumatismo vertebromedular
	  collapsed:: true
		- Diferenças anatômicas
			- Ligamentos interespinhosos e cápsulas articulares mais flexíveis
			- Corpos vertebrais tendem a escorregar para frente com flexão
			- Articulações planas
			- Cabeça maior, mais lesões a nível de C3
			- Placas de crescimento abertas
			- Forças aplicadas ao pescoço proximal maiores
		- Considerações radiológicas
			- Pseudosubluxação - diferenciar na radiografia de perfil da coluna cervical se mesmo pseudoluxação ou lesão de coluna - Coxim de 2,5 cm no dorso e repetir o exame
			- Deformidade em degrau na palpação suave da coluna vertebral indica lesão
			- Fraturas podem partir dos centros de crescimento ósseo
			- Pode haver lesões de medula sem achado radiográfico. Radiografia não exclui suspeita de lesão medular.
			- TC e RNM não devem ser rotina em pediatria
	- Trauma musculoesquelético
	  collapsed:: true
	  Cuidado especial para os núcleos de crescimento ósseo
		- História
			- Diagnóstico radiográfico difícil por menor calcificação, fazendo a história ainda mais relevante
			- Indicadores de maus tratos
				- Fraturas múltiplas em diferentes fases de consolidação
				- Fraturas em MMII em crianças que ainda não deambulam
		- Perda sanguínea por fraturas
			- Menor em crianças que em adultos
			- Fratura de fêmur sozinha geralmente não provoca choque. Procure por outras lesões também
		- Considerações especiais sobre o esqueleto imaturo
			- Lesões nas placas de crescimento podem prejudicar o desenvolvimento ósseo
			- Difíceis de diagnosticar porque são radiotransparentes
			- Fratura em galho verde e fratura em fivela podem ser sinal de maus tratos
			- Fraturas de cotovelo e joelho podem se associar a lesão de placa de crescimento e lesão vascular
		- Imobilização de fraturas
			- Tente reduzir somente uma vez.
			- Imobilize, tracione e observe sinais de lesão vascular
	- Maus tratos
	  collapsed:: true
		- Qualquer lesão intencional dos cuidadores
		- Homicídio é a causa mais comum de lesão fatal no primeiro ano de vida
		- Lesão não-acidental tem maior mortalidade que lesões acidentais
		- Indícios
		  collapsed:: true
			- Discrepância entre história e lesão física
			- Intervalo de tempo prolongado entre o trauma e a busca por socorro
			- Traumatismo de repetição e atendimento em múltiplos hospitais
			- Divergência entre relato do mecanismo do trauma entre os cuidadores
			- História de consultas médicas frequentes
			- Cuidadores que não respondem adequadamente ou não seguem orientações médicas
			- Mecanismo de trauma não é plausível com idade e desenvolvimento da criança
		- Sinais ao exame
		  collapsed:: true
			- Equimoses múltiplas e em diferentes estágios de cicatrização
			- Evidência de lesões traumaticas prévias repetidas
			- Lesões periorais
			- Lesões perineais ou perianais
			- Fraturas de ossos longos em crianças menores de 3 anos
			- Ruptura de vísceras sem mecanismo de trauma de grande intensidade
			- Hematomas subdurais múltiplos
			- Hemorragia retiniana
			- Lesões bizarras
			- Queimaduras de segundo e terceiro graus demarcadas
			- Fraturas de crânio ou arcos costais em menores de 2 anos
		- Reporte às autoridades legais
	- Prevenção
	  collapsed:: true
		- ABCDE da prevenção do trauma pediátrico
			- A - analise os dados sobre trauma
			- B - Construa coalizões locaos
			- C - Comunique o problema
			- D - Desenvolva atividades de prevenção
			- E - Avalie as intervenções
	- Trabalho em equipe
	  collapsed:: true
		- Idealmente, equipe e centro especializado em trauma pediátrico
		- Se não houver, deve-se ter referências pediátricas e treinamento específico para essa população
- # 11 - Trauma no Idoso
  collapsed:: true
	- Introdução
	  collapsed:: true
		- Cada vez mais idosos
		- Quinta causa de morte nesta população
		- Mecanismos de lesão semelhante aos do jovens, porém maior morbimortalidade
	- Efeitos do envelhecimento e impacto de condições pré-existentes
	  collapsed:: true
		- Diminuição da função celular - Diminuição da reserva fisiológica
		- Condições pre-existentes com impacto no trauma
			- Cirrose
			- Coagulopatia
			- DPOC
			- Isquemias cardíacas
	  ...
	  collapsed:: true
		- Quedas
		  collapsed:: true
			...
			- mecanismo mais comum de ferimento fatal
			- Fatores de risco
				- Pessoais
					- idade avançada
					- deficiência física
		...
		- Acidentes de automóvel
			...
			- Um mal súbito pode ser o fator causal do acidente
		- Queimaduras
			- Devastadoras em idosos, mesmo pequenas
	...
	- Avaliação inicial com reanimação
	  collapsed:: true
		- Via aerea
		  collapsed:: true
			- Dentaduras podem obstruir via aérea e também dificultar laringoscopia
			- Falta de dentes dificulta ventilação por AMBU
			- Artrite pode dificultar a laringoscopia
			- Diminuir barbitúricos e benzodiazepínicos em 20%
		- Respiração
		  collapsed:: true
			- Aumento da cifoescoliose
			- Diminuição da capacidade residual funcional
			- Insuficiência respiratória mais insidiosa
		- Circulação
		  collapsed:: true
			- Débito e frequência cardíaca fixos
			- Pacientes com hipertensão podem estar "em hipotensão" com valores normais de PA
			- Em idosos, PAS < 110 já pensar em hipotensãoM
			- Marcadores laboratoriais de choque, como lactato e base excess
			- Idoso com hipotensão, até que prove o contrário, está sangrando.
		- Disfunção neurológica
		  collapsed:: true
			- Maior risco de hematoma peridural
			- Uso de anticoagulantes e antiplaquetários
			- Atrofia cerebral pode fazer com que hemorragias demorem mais a ter repercussões clínicas
			- Risco de fratura e lesão medular mesmo com traumas de baixa energia
			- Faça uso menos preocupado da TC
		- Exposição e ambiente
		  collapsed:: true
			...
			- Comorbidades
			- Terapias médicas
			- Imobilidade - maior risco de úlceras por pressão
	- Lesões específicas
	  collapsed:: true
		- Fraturas de costela
			- Ossos mais frágeis
			...
			- Controle da dor para permitir respiração adequada
			- Durante internação, evite depressão e delirium
		- Trauma caranioencefalico
			- Maior mortalidade
			- Confunde com demência, depressão e delirium
			- Tente retornar ao estado de coagulação normal
		- Fraturas de pelve
			- Queda da própria altura
			- Osteoporose
			- Maior necessidade de transfusão
			- Sequelas após internação com perda da funcionalidade
	- Circunstâncias especiais
	  collapsed:: true
		- Uso prévio de medicamentos
		  collapsed:: true
			- Beta-bloqueadores diminuem resposta à hipovolemia
			- Anticoagulantes e antiagregantes aumentam hemorragia
		- Abuso no idoso
		  collapsed:: true
			- Lesão intencional, confinamento irracional, intimidação ou castigo cruel
			- Classificação
			  collapsed:: true
				- Abusos físicos
				- Abuso sexual
			...
			- Sinais
			  collapsed:: true
				...
				- Atraso intencional do tratamento
			- Achados físicos sugestivos
			  collapsed:: true
				- Contusão em região interna dos braços e das coxas, palmas das mãos e pés, couro cabeludo, orelha, mastóide e nádegas
				- Contusões múltiplas agrupadas
				- Abrasões na área axilar, punho ou tornozelo (amarras)
				- Lesão nasal ou na região temporal (enquanto usava óculos)
				- Equimose periorbital
				- Lesão oral
				- Alopecia de padrão incomum
				- Úlcera de pressão não tratada ou em áreas não lombossacrais
				- Fraturas não tratadas
				- Fraturas em regiões diferentes de quadril, úmero e vértebra
				- Lesões em vários estágios de evolução
				- Lesões nos olhos ou nariz
				- Queimadura por contato ou escaldadura
				- Hemorragia ou hematoma por escalpe
		- Estabelecendo metas de cuidado
		  collapsed:: true
			- Desejo em terapias para manutenção de vida
			- Cuidados paliativos
	- Trabalho em equipe
		- Serviço de urgência mais sensível a idosos, socorrendo mesmo coisas mais simples para evitar complicações
- # 12 - Trauma na gestante e violência conjugal
  collapsed:: true
	- Introdução
	  collapsed:: true
		- Lembre que está atendendo dois doentes
		- O melhor tratamento para o feto é a reanimação adequada da mãe
		- Monitorização dos dois
	  ...
	  collapsed:: true
		- Diferenças anatômicas
		  collapsed:: true
			- Útero
			  collapsed:: true
				- intrapélvico ate 12 semanas
				- A nível de cicatriz umbilical na 20 semana
				- rebordo costal entre a 34 e 36 semana
				- Nas duas últimas semanas, desce por conta do encaixe do feto na pelve
				- Conforme o útero cresce, protege as vísceras ocas, mas torna-se mais exposto a lesões.
				- Lesões perfurantes no abdome superior se tornam mais complexas
			- Irritação peritoneal menos evidente
			- Líquido amniótico pode causar embolia
			- Fraturas pélvicas na gravidez avançada podem lesionar o feto
			- Chance de descolamento de placenta no trauma
			- Hipovolemia da mãe pode causar hipóxia no feto, mesmo se sinais vitais maternos preservados
		- Volume e composição do sangue
		  collapsed:: true
			- Volume plasmático aumentado
			- Hematócrito diminuído
			- Maior reserva fisiológica à perda sanguínea para a mãe, mas com possível hipóxia fetal
		...
		- Hemodinâmica
		  collapsed:: true
			- Débito Cardíaco
			  collapsed:: true
				- Débito cardíaco aumenta após a 10 semana em aprox. 1 litro
				- Susceptibilidade ao posicionamento corporal por compressão da veia cava
			- Pressão Sanguínea
			  collapsed:: true
				- Queda de 5 a 15 mmHg no segundo trimestre
				- Hipotensão supina por compressão da veia cava
				- Hipertensão pode ser pré-eclâmpsia
			- Alterações no ECG
			  collapsed:: true
				- Eixo desviado para esquerda em até 15 graus
				- Achatamento ou inversão de onda T em D3, AVF
				- Extrassístoles
		- Sistema respiratório
		  collapsed:: true
			- Hipocapnia fisiológica
			- PaCO2 normal de 35-40 pode ser início de insuficiência respiratória em grávidas
			- Diminuição de volume residual
		- Sistema gastrointestinal
		  collapsed:: true
			- Esvaziamento gástrico prolongado
			- Descompressão gástrica precoce
			- Baço e fígado mantém posicionamento
		- Sistema urinário
		  collapsed:: true
			- Maior filtração glomerular
			- Ureia e creatinina caem
			- Glicosúria é comum
		- Sistema musculoesquelético
		  collapsed:: true
			- Sínfise púbica alargada
			- Maior chance de hemorragia retroperitoneal maciça
		- Sistema neurológico
		  collapsed:: true
			- Eclâmpsia simula TCE
			- Excluir TCE com TC
			- Suspeitar de eclâmpsia se convulsões, hipertensão e proteinúria
	- Mecanismo de trauma
	  collapsed:: true
		- Trauma fechado
		  collapsed:: true
			- Parede abdominal, uterina e líquido amniótico protegem o feto de trauma direto
			- Escoriações na parede abdominal podem ser sinal de trauma uterino
			- Pode haver lesão indireta do feto, principalmente descolamento de placenta
			- Não usar o cinto de segurança é trágico. Lesões com cinto de segurança também são comuns. O de 3 pontos é melhor.
		- Trauma penetrante
		  collapsed:: true
			- Melhor prognóstico para a mãe
			- Péssimo prognóstico para o feto
	- Gravidade do trauma
	  collapsed:: true
		- A gravidade define o nível de suporte requerido
		- Idealmente, as gestantes devem ser encaminhadas para centros com capacidade cirúrgica e obstétrica
	- Avaliação e tratamento
	  collapsed:: true
	  Reanime primeiro a mãe
		- Avaliação primária e reanimação
		  collapsed:: true
			- Materna
			  collapsed:: true
				- ABCDE
				- PCO2 ideal para idade gestacional -  aprox 30 no ultimo trimestre
				- Descomprimir veia cava deslocando útero para esquerda. Gestante ou prancha a 15 graus para lado esquerdo em relação ao chão.
				- Manter hipervolemia fisiológica da gravidez com cristaloides a fim de evitar hipóxia fetal
				- Vasopressores causam hipóxia fetal
				- Dosar fibrinogênio, que deve estar próximo do dobro normal
			- Fetal
			  collapsed:: true
				- Exame abdominal mandatório
				- Morte materna é primeira causa de morte fetal
				- A segunda é descolamento de placenta
				- Sinais de descolamento
				  collapsed:: true
					...
					- tetania uterina
					- irritabilidade do útero
				- Ruptura uterina é rara e se apresenta com sinais de irritação abdominal, posição anormal do feto, facilidade de palpar partes fetais e dificuldade de palpar o fundo uterino
				- Monitore BCF
				- Fatores de risco para descolamento de placenta
					- FC materna > 110
					- Índice de gravidade de lesão > 9
					- BCF > 160 ou < 120
					- Ejeção do veículo
					- Atropelamento
					- Colisão de moto
		- Auxiliares para avaliação primária e reanimação
		  collapsed:: true
			- Materna
				- Monitorização em decúbito lateral esquerdo
				- Oximetria
				- Gasometria - bicarbonato é menor na gestação
			- Fetal
				- monitorar BCF
				- Evitar exames de imagem desnecessários
		- Avaliação secundária
		  collapsed:: true
			- Atenção às contrações uterinas e ao trabalho de parto prematuro
			- Líquido amniótico na vagina sugere ruptura da bolsa
			- Embolia amniótica, causando coagulação intravascular disseminada
			- Risco de Isoimunização em todas as gestantes RH negativas
	- Cesaria perimortem
	  collapsed:: true
		- Se a causa da parada cardíaca materna for hipovolemia, não há indicação, pois feto já está em prolongado período de hipóxia.
		- Se a causa da parada for outra, há indicação, mas somente dentro dos primeiros 5 minutos de parada.
	- Violência conjugal
	  collapsed:: true
		- Suspeita deve ser denunciada. Acione serviço social também.
		- Indicadores
		  collapsed:: true
			- Lesão desproporcional à história
			- Redução da autoestima, depressão e tentativa de suicídio
			- Autoabuso
			- Consultas médicas frequentes - múltiplas entradas em PS
			- Sintomas sugestivos de abuso de drogas
			- Autoacusação por lesões apresentadas
			- Insistência do parceiro em permanecer na consulta
		- Perguntas de triagem para segurança imediata
		  collapsed:: true
			- Você está em perigo imediato?
			- Seu cônjuge está nesta instituição agora?
			- Você quer ir para casa com seu cônjuge
			- Você tem algum lugar seguro pra ir?
			- Houve abuso ou ameaça aos seus filhos?
			- Você teme que sua vida possa estar em perigo?
			- A violência tornou-se pior ou mais frequente?
			- Seu cônjuge usa armas, álcool ou drogas?
			- Seu cônjuge já segurou você ou seus filhos contra sua vontade?
			- Seu cônjuge já a vigiou, seguiu ou perseguiu?
			- O seu cônjuge já ameaçou matar você, seus filhos ou a si mesmo?
	- Trabalho em equipe
		- Prioridade é a mãe
		- Notificar obstetra
		- Suspeitar de violência doméstica
- # 13 - Transferência para o Tratamento Definitivo
  collapsed:: true
	- Introdução
	  collapsed:: true
		- Se o tratamento definitivo não pode ser provido no hospital local, ele deve ser transferido para um que possa. Idealmente, um centro de trauma.
		- A decisão de transferir depende das lesões do doente, nível de gravidade e capacidade tecnológica do local.
		- O objetivo central é não causar dano adicional
	- Determinação da necessidade de transferência do doente
	  collapsed:: true
	  Se o hospital local pode resolver, não precisa transferir.
		- Fatores de transferência
		  collapsed:: true
			- TCE grave e choque são indicações óbvias
			- Politrauma é mais difícil de definir
			- Indicado transferir se capacidade tecnológica local for insuficiente
			- Trauma contuso de vísceras sólidas pode até não precisar de cirurgia, mas devem ser acompanhadas por cirurgião
			- Trauma com grande transferência de energia ou atingindo muitos sistemas podem necessitar de transferência
			- Morte de outro paciente envolvido no mesmo acidente também exige monitorização cuidadosa
		- Tempo de transferência
		  collapsed:: true
			- O desfecho depende do tempo transcorrido entre o acidente e o tratamento definitivo
			- Comunicação eficaz com o centro que vai receber
			- Se você puder resolver na cena, resolva. Basicamente, resolva tudo o que puder no nível de complexidade aonde está agora.
			- Intervenção apropriada antes do transporte sempre que possível, mas não atrase buscando diagnóstico.
			- Estabilização está acima de diagnóstico.
			- Transferência para centro adequado está acima de diagnóstico.
	- Tratamento antes da transferência
	  collapsed:: true
		- Estabilizar o doente = transferir melhor
		- Orientações durante o transporte
		  collapsed:: true
			- A
			  collapsed:: true
				- Garantir via aérea o quanto antes sempre que necessário
				- estar atendo à chance de deterioração no transporte, intubando se houver indícios de necessidade breve.
				- Aspirar
				- Passar sonda nasogátrica em todos os que precisarem de tubo e naqueles com distensão gástrica.
			- B
			  collapsed:: true
				- Aferir frequência respiratória
				- Oxigênio suplementar
				- Ventilação mecânica, se necessário
				- Dreno de tórax se necessário, em especial se pneumotórax + necessidade de intubação
			- C
			  collapsed:: true
				- Controlar sangramento externo
				- Observar tempo de torniquete
				- Dois acessos venosos calibrosos
				- Infundir cristaloide e/ou sangue
				- Sonda vesical de demora e débito urinário
				- Monitorizar ritmo e frequencia cardiaca
				- Decúbito lateral esquerdo para gestantes
			- D
			  collapsed:: true
				- Imobilizar a coluna
				- Ventilação se RNC
				- Manitol ou solução salina hipertônica se sinais de PIC elevada
			- E
			  collapsed:: true
				- Se possível, obter radiografias de tórax, pelve e extremidades
				- Colher laboratório
				- Manter monitorização de ECG e Oximetria
			- F - Ferimentos e fraturas
			  collapsed:: true
				- Limpar e cobrir ferimentos
				- Profilaxia de tétano
				- Antibióticos, se indicado
				- Talas e tração em fraturas
		- Lista de verificação de intervenções
		- Pacientes que estão agitados e precisarem de sedação devem ser intubados. Avaliar ABCDE e tentar tranquilizar antes de sedar.
		- Sedação é sempre perigoso em pacientes com hipovolemia e choque
	- Responsabilidade da transferência
	  collapsed:: true
		- Médico que encaminha
		  collapsed:: true
			- Decide pela transferência
			- Realiza as intervenções antes e durante a transferência
			- Deve contactar o médico a receber
			- Decidir para qual centro é adequada a transferência
			- Acompanhar o doente na transferência ou garantir equipe adequada para isso
			- Transmitir informações de forma padronizada
			- ABC-SBAR
			  collapsed:: true
				- ABC
				  collapsed:: true
					- Todos os problemas de via aérea, respiração e circulação identificados
				...
				- R - Recomendação
				  collapsed:: true
					...
					- Intervenções medicamentosas durante transporte
					- Avaliações e intervenções necessárias
		- Médico que recebe
			- Ser consultado e estar ciente se nível tecnológico de seu centro é capaz de receber o paciente
			- Caso não possa aceitar o paciente, ajudar na busca de um centro que possa.
	- Modos de transporte
	  collapsed:: true
	  Não causar dano adicional
		- Transporte térreo, aquático e aéreo
		- Condições geográficas do transporte devem ser consideradas
		- O transporte vai desfalcar o recurso local?
		- Transferência inter-hospitalar do doente instável é perigosa, procure estabilizar antes
	- Protocolos de transferência
	  collapsed:: true
		- Comunicação direta entre médico que transporta e médico que recebe
		- Comunicação sobre as condições e necessidades do paciente para a equipe
		- Documentação com informações sobre o resgate acompanhando o doente
		- Tratamento durante o transporte
		  collapsed:: true
			...
			- Reposição volêmica
			- Medicamentos
			- Comunicação com o médico a receber durante a transferência
			- Manutenção de registro
	- Transferência de dados
		- Informações devem acompanhar paciente
	- Trabalho em equipe
		- Transferir sempre para local que possa atender À demanda
		- Comunicação com instituição receptora
		- Limitar exames àqueles que realmente mudam tratamento
		- Garantir repasse adequado de informações
- # Apêndices
  collapsed:: true
	- A - Trauma Ocular
	  collapsed:: true
		- Introdução
		  collapsed:: true
			- Vida, membros ou visão
			- O olho é uma das maiores prioridades após a estabilização do doente devido ao nível de prejuízo funcional possível
		- Revisão de anatomia
		  collapsed:: true
			- Córnea - camada transparente que delimita câmara anterior
			- Cristalino define segmentos anterior e posterior do globo
			- Segmento anterior é córnea, esclera, conjuntiva, íris e cristalino, preenchido por humor vítreo
			- Segmento posterior é a câmara entre o cristalino e a retina, preenchida por humor vítreo
			- Nervo óptico na parte posterior, passando pelo cone muscular, pela órbita e então para o cérebro
			- O cone muscular também tem uma fáscia, podendo sofrer síndrome compartimental
			- A órbita é o espaço ósseo no crânio para acoplamento do olho
			-
		- Avaliação
		  collapsed:: true
			- História
			...
			- Exame físico
			  collapsed:: true
				- Três sinais do olho - Visão, pupilas e pressão intraocular
				- Visão
					- Teste de leitura
					- Teste de olhar dentro de um pequeno orifício
				- Pupilas
					- Remova lentes de contato
					- Pupilas devem ser iguais, redondas e fotorreagentes
					- Pupilas desiguais ou não reagentes podem significar trauma encefálico ou direto do olho, se o TCE for descartado
					- Teste da lanterna oscilante
				- Pressão intraocular
					- Tonometria
					- Pressão palpebral lateral
					- Se suspeita de lesão aberta no olho, não verifique a pressão
				- Exame anterior
					- Periórbita
					  collapsed:: true
						- Equimoses
					...
					- Hemorragia retrobulbar
					  collapsed:: true
						- Pressão ao empurrar o olho
						- Não conseguir afastar a pálpebra do olho
					- Músculo extraoculares
					  collapsed:: true
						- Seguir o dedo para cima, lados e baixo
					- Ductos lacrimais e pálpebras
					  collapsed:: true
						- Reconstrução se necessário em até 72h
						- Coloração com fluoresceína para avaliar lacerações associadas na córnea e esclera
					- Íris
					  collapsed:: true
						- Ruptura pupilar
						- Irregularidades
					- Câmara anterior
					  collapsed:: true
						- Avalie distância entre córnea e íris, se diminuída pode significar vazamento de humor vítreo
						- Hifema - sangue na câmara anterior. Pode causar pressão ocular muito elevada
					- Cristalino
					  collapsed:: true
						- Deve ser transparente ou levemente amarelado
						- Cristalino violado fica branco e forma edema, podendo significar corpo estranho intraocular
				- Exame posterior
					- Reflexo vermelho
					- Oftalmoscópio
		- Lesões oculares específicas
		  collapsed:: true
			- Fraturas de órbita e hemorragias retrobulbares
			  collapsed:: true
				- Sagramento para compartimento retrobulbar pode causar contrição do nervo óptico e de estruturas vasculares que irrigam o globo
				- Sinais são redução da acuidade visual, pressão ocular elevada, proptose assimétrica, resistência à retropulsão e pálpebras tensas contra o globo
				- TC pode ajudar no diagnóstico, mas não atrase.
				- Ao suspeitar, fale com cirurgião imediatamente. Perda definitiva da visão pode ocorrer em 2h.
			- Queimaduras químicas
			  collapsed:: true
				- Tratar assim que o doente chegar
				- Irrigar abundantemente com cristaloides. Agua de torneira só se soluções estéreis indisponíveis
				- Consiga informações sobre qual produto químico causou a queimadura
				- Reavalie o pH do olho a cada 30 minutos
			- Ruptura do globo ocular
				- Lesões penetrantes ou corpo estranho
				- sinais são pupila pontiaguda, camara anterior rasa, laceração da cornea ou esclera, tecido pigmentado anormal aparecendo através da esclera ou da cornea, exame com sangue no humor vitreo
				- Teste de fluoresceína
				- São emergências cirúrgicas, contate o cirurgião imediatamente.
				- Precauções antes do transporte
				  collapsed:: true
					- Coloque um protetor rígido para proteger o olho
					- Nunca coloque um curativo sob pressão, nem mesmo gaze.Quanto mais pressão, mais lesão
					- Utilize antibioticos - quinolonas, de preferência levofloxacino. Se indisponível, cubra gram positivos e negativos. Imunize para tétano.
					- Minimize a movimentação dos olhos
					- Trate dor, náusea e tosse para evitar valsalvas
					- Minimize a manipulação do olho
		- Na dúvida, chame o oftalmologista
	- B - Hiportermia e Lesões pelo Calor
	  collapsed:: true
		- Introdução
		  collapsed:: true
			- Termorregulação entre 36,4 e 37,5
			- Exposição ao frio pode causar dano sistêmico e morte
			- Exposição ao frio pode ser isolada ou estar acompanhada de outros traumas
		- Hipotermia
		  collapsed:: true
			- Temperatura corporal central abaixo de 35° C
			- Preocupante em pacientes traumatizados
			- Idosos são particularmente suscetíveis, comum em crianças também.
			- Classificações
			  collapsed:: true
				- Classificação para hipotermia isolada
				  collapsed:: true
					- Leve: 35-32°C
					- Moderada: 32-30°C
					- Grave: < 30°C
				- Classificação para hipotermia + trauma
				  collapsed:: true
				  Lesão traumática + hipotermia = aumento de mortalidade
					- Leve: 36°C
					- Moderada: 36-32°C
					- Grave: < 32°C
				- Estadiamento e manejo de hipotermia acidental
				  collapsed:: true
					- |Estadio|Sintomas Clínicos|Temperatura central Típica|Tratamento|
					  |--|--|--|--|
					  |1|Tremores conscientes|35 a 32 °C|Roupas e ambiente aquecido, bebidas doces e quentes e movimentos ativos (se possível)|
					  |2|Consciência alterada, sem tremores|< 32 a 28 °C|Monitorização cardíaca, movimentos mínimos e cautelosos para evitar arritmias, decúbito horizontal e imbilização, isolamento de corpo inteiro, reaquecimento|
					  |3|Insconciente, sem tremores, sinais vitais presentes|< 28 a 24 °C|Tratamento como no estadio 2, manejo de vias aéreas, ECMO ou CPB em casos de instabilidade cardíaca refratária ao tratamento medicamentoso|
					  |4|Ausência de Sinais Vitais|< 24 °C|Tratamento como no estadio 3 e até 3 doses de epinefrina (1 mg) e desfibrilação, com doses adicionais baseadas na resposta clínica. Reaquecimento com ECMO ou CPB. RCP com reaquecimento externo ativo ou interno alternativo.|
				  ...
				  collapsed:: true
					- Aguda
					  collapsed:: true
						...
						- Avalanches
						- 30 minutos para se estabelecer
					- Subaguda
					  collapsed:: true
						- Exposição lenta
						- Esgotamento das reservas do corpo e hipovolemia
					- Subcrônica
					  collapsed:: true
						- Exposição prolongada ao frio leve
						- Exemplo clássico idoso no chão por horas após queda
			- Sinais
			  collapsed:: true
				- Leve
					- Tremor é sinal precoce
					- Pele fria
				- Moderada
					- Confusão mental
					- Amnésia
			  ...
			  collapsed:: true
				...
				- Arritmias
				  collapsed:: true
					...
					- Assistolia
				- Medicamentos cardiológicos perdem eficácia, devendo ser postergados ao menos até reaquecer a 28°C
			- Tratamento
			  collapsed:: true
				- ABCDE e RCP
				- Remova o paciente do ambiente frio
				  ...
				  collapsed:: true
					...
					- Ativo
						...
						- Extracorpóreo
							...
							- Reaquecimento venovenoso contínuo
							- Bypass Cardiopulmonar
				- Monitorizar ECG
				  collapsed:: true
					- Se houver ritmo organizado, evite RCP
					- Se ritmo desorganizado, RCP
				- Evitar usar acesso central subclávio ou jugular, preferir femoral
				- Procure por lesões ocultas
				- Não atrasar transferência
			- Morte
			  collapsed:: true
				- Declarar a morte é difícil em pacientes com hipotermia.
				- Só declare morto após todos os esforços de reaquecimento.
				- Só está morto se estiver quente e morto.
				- Exceto se hipóxia pregressa à hiportermia, K > 10 mmol/L ou lesão incompatível com a vida
		- Lesões por calor
		  Exposição prolongada ao calor pode levar a temperatura corporal excessiva
				  ...
				  collapsed:: true
					...
					- Sintomas
					  collapsed:: true
						...
						- Mal estar
						- Mialgia
					- Consciência inalterada e temperatura abaixo de 39° C
				- Insolação
				  collapsed:: true
					- Ameaçadora à vida, os que sobrevivem podem te sequelas neurológicas permanentes
					- Sinais clínicos
					  collapsed:: true
						- Temperatura central > 40° C
						- Taquicardia
						- Taquipneia
						- Hipo ou normotensos, com pressão de pulso aumentada
						- Pele quente e seca ou diaforética e pegajosa
					...
					- Classificação
					  collapsed:: true
						- Clássica ou Passiva
							- Ondas de aquecimento ambientais
							- Afeta mais extremos de idade e deficientes físicos e mentais
						- Por esforço
							- Exercícios extenuantes
							- Trabalho em locais quentes e úmidos
			- Fisiopatologia
			  collapsed:: true
				- Calor corporal é gerado por processos metabólicos e exposição ao ambiente
				- Respostas à temperatura elevada
				  collapsed:: true
					- vasodilatação periférica
					- sudorese - normalmente 1,5 L por hora
					- Aumento do débito cardíaco para mais de 20 L/min
					- Desnaturação proteica
					- Resposta inflamatória
			- Tratamento
			  collapsed:: true
				- Broncoaspiração e hipóxia são as principais causas de morte - ABCDE neles
				- Oxigênio suplementar
				- Se hipóxia, hipercapnia ou RNC, intubar
				- Laboratório com gasometria, eletrólitos e função renal o mais rápido possível.
				- Resfriamento imediato
					- Chegar abaixo de 39°C nos primeiros 30 minutos
					- Spray de água
					- Fluxo de ar
					- Gases úmidas
					- Pacotes de gelo em áreas de maior fluxo sanguíneo
					- Ventiladores
					- Arco de sonado
					- Se paciente jovem, imersão em água gelada.
					- Unidade de resfriamento corporal
					  Máquina que pulveriza água a 15 graus nas pessoas
			- Farmacologia
			  collapsed:: true
				- Dantrolene em hipertermia maligna ou síndrome neuroepilética maligna. Não tem eficácia em insolação.
				- Estimulantes podem aumentar risco de insolação, assim como álcool, diuréticos, anti-histamínicos e anti-colinérgicos.
				- Anfetaminas e salicilatos podem aumentar o ponto hipotalâmico de termorregulação
				- Litium e ISRS podem interferir na termorregulação
			- Indicadores de Mau Prognóstico
			  collapsed:: true
				...
				- Idade avançada
				- Temperatura > 41
				- Longa exposição e duração
				- Coma prolongado
				- Hipercalemia
				- Oligúria
				- IRA
		-
	- C - Incidentes com vítimas em massa, Traumas em Ambientes Hostis e Conflitos Armados
	  collapsed:: true
		- Introdução
			- Ambientes com recursos limitados dificultam o socorro prestado
			- Conhecer bem a situação extrema em que se está
			- Nenhum lugar está imune a desastres
			- Nesses locais, há severa limitação de recursos e o número de vítimas supera a capacidade de atendimento
			- O gerenciamento de desastres requer padronização de atitudes
			- Adapte-se e resolva
		- Tratamento de vítimas em massa
			- Número de vítimas excede os recursos
			- Mude de "o melhor possível para cada indivíduo" para "o melhor possível para o maior número de vítimas"
			- Em um desastre, as decisões tomadas para uma vítima pode impactar no tratamento a outras vítimas.
			- Falha em tomar decisões =  aumento da mortalidade
			- Disposição da catástrofe
			  Vitimas x recursos x situação
				- Características das vítimas
					- Lesões que ameaçam a vida
					- Gravidade das lesões
					- Possibilidade de sobrevivência
					  collapsed:: true
						- Absoluta - Lesões incompatíveis com a vida
						- Relativa - Lesões que esgotariam os recursos que poderiam salvar mais vidas
				- Recursos
					- O que está disponível para cuidado e transferência?
					- Quanto tempo levará para transportar vítimas?
					- Quanto tempo levará para reabastecer os recursos?
				- Situação
					- Progressão do evento
					- Eventos secundários
					- Condições ambientais
		- Ferramentas para o cuidado efetivo de vítimas em massa
			- Sistema de comando de incidentes
				- Ferramenta administrativa
				- Integra e coordena diferentes esforços
				- Reorganiza a logística para melhor aproveitamento de recursos
				- Objetivos
					- Segurança dos socorristas
					- Salvar vidas
					- Estabilizar o incidente
					- Preservar propriedade e ambiente
				- Cuidados gerais são mais necessários que cuidados especializados
			- Triagem
				- Classificar vítimas de acordo com prioridade de atendimento
				- Fazer o melhor para a maioria
				- Passos
					- Remover vítimas vivas e concentrar em um ponto seguro
					- Determinar quem está criticamente ferido usando métodos de triagem
					- Separar doentes por categorias em áreas definidas
						- Vermelho - Sala de emergência
						- Amarelo - Ambulatórios
						- Verdes - Fora das áreas de atendimento prioritário, em prédios adjacentes
						- Cinza - área específica. Reavaliar após mudança nos recursos.
						- Preto - Morgues, mas só se sobrar tempo e pessoas para transportar.
				- Métodos de triagem
					- START
						- RPM - 30-2-Pode fazer
							- Respiração - 30 segundos avaliando capacidade respiratória
							- Perfusão - 2 segundos avalia perfusão
							- Mental - Pode fazer -  Capacidade de obedecer a comandos
							- {{embed ((6269d054-5d87-4366-8015-402a61649a07))}}
							  id:: 628eb8c3-2ef3-45b0-a22a-afcd19838fa3
					- SALT
						- S - Sort - Classificar
						- A - Avaliar
						- L - Life-saving - Intervir para salvar vidas
				...
				- Classificação por cor
					- Verde - Atendimento a posteri, se sobrar
					- Amarelo - Atendimento em até 6 horas
					- Vermelho - Atendimento Imediato
					- Cinza - Pacientes com poucas chances de sobrevivência. Atendimento a posteri, se recursos disponíveis.
					- Preto - óbito
			- Prioridades de tratamento
				- Improvisação frente a indisponibilidade de recursos
				  collapsed:: true
					- Tubo de caneta para traqueostomia
					- Imobilização cervical com lençóis ou sapato
					- Ouvido ao invés de otoscópio
					- Drenos de tórax com dedo de luva, ao invés de válvula.
					- Torniquetes com cintos, roupas ou cabos
					- Imobilização sacral com lençóis
					- Sutura contínua em escalpelamentos
				- Adiar avaliação secundária e cuidados definitivos
			- Desafios
				- Comunicação
				- Transporte - Utilize qualquer veículo para transporte de vítimas
				- Segurança
				- Proteção das instituições
				- Logística
				- Voluntários em massa e autoadmissão
				- Populações especialmente vulneráveis
				- Perda de estrutura básica - água, saneamento, proteção das intempéries
				- Burn-out da equipe de resgate
				- Traumas psicológicos
			- Lesões multidimensionais
			  Lesões fora do habitual, típicas de guerras e desastres, com alta transferência de energia
				- Primária - Lesão direta
				- Secundária - Lesão por fragmentos ou lesões menores
				- Terciária - Lesões provocadas por impacto ou perfuração por objetos no ambiente
				- Quaternária - Queimaduras, esmagamentos e infecções
		- Desafios em ambientes táticos, hostis e com restrição de recursos
			- Segurança e comunicação
			  collapsed:: true
				- Proteger recursos críticos
				- Restringir entrada de pessoas
			- Ferimentos de guerra
			  collapsed:: true
				- Ambiente de guerra e ataques terroristas têm lesões com mais alta energia do que ambiente civil
			-
		- Cuidados ao doente traumatizado no ambiente militar
			- Cuidado de Feridos em combate tático
			  collapsed:: true
			  Cursos específicos para ambiente tático - PHTLS e TCCC
				- Cuidados sob fogo cruzado
					- Focar em superioridade tática e supressão dos ataques
					- Controle de sangramentos ativos
				- Cuidados táticos em campo
					- Após cessar fogo
					- Estar atento para reengajamento do inimigo
					- CAB no lugar de ABCDE - C primeiro
				- Cuidados Táticos de retirada
					- Colocar vítima em plataforma médica de retirada
					- Continuar intervenções da fase anterior
					- Minimizar intervenções não urgentes e focar no transporte rápido.
			- ATLS - OE (Operational Enviroment)
			  collapsed:: true
				- Avaliação Zero
				  collapsed:: true
					- Avaliação de capacidades internas e fatores externos
					- Preparar para receber as vítimas
					- Triagem
					...
					- Perguntas norteadoras
					  collapsed:: true
						- Quantos e quais são os tipos de profissionais de saúde disponíveis?
						- Quais especialidades médicas e cirúrgicas estão disponíveis?
						- Qual é a quantidade e qual a tipagem dos componentes sanguíneos disponíveis?
						- Existe escassez de algum suprimento?
						- A reposição de suprimentos, inclusive de componentes sanguíneos, está disponível?
						- Existe a necessidade de realizar a transfusão de sangue Total?
						- Quais os dispositivos para oxigenação estão disponíveis?
						- A comunicação direta para transferência de um doente está disponível, caso seja necessário?
						- Qual a situação tática? A segurança do local é adequada
				- Avaliação Terciária
				  collapsed:: true
					- Nenhuma lesão foi esquecida?
				- Avaliação Quaternária
				  collapsed:: true
					- Ambientes hostis podem significar necessidade de múltiplas transferências de um doente
					- Preparo para transferências seguras
					- Garantir que o transporte esteja prontamente disponível
					- Antever complicações durante o transporte
					- Condições climáticas
					- Possibilidade de conflito no percurso
					- Equipe preparada para complicações
					- Equipamentos e medicamentos requeridos no transporte
		- Aumentando a sobrevivência em incidentes com atiradores ativos e eventos com vítimas de massa provocados intencionalmente
			- Consenso de Hartford
				- Atiradores e explosões intencionais
				- Treinar socorristas e público leigo no controle das hemorragias
				- THREAT
					- Threat supression - Supressão de ameaças
					- Hemorrhage Control - Controle de Hemorragias
					- Rapid Extrication - Retirada rápida
					- Assesment - Avaliação por profissionais de saúde
					- Transport - Transporte para cuidado definitivo
			- Pare o sangramento
				- Ensinar ao público leigo como agir ao presenciar uma ameaça
				- Pressão direta -> Curativo e pressão direta -> Torniquete
	- D - Conduta em desastres e Prontidão para Emergências
	  collapsed:: true
		- Introdução
			- O atendimento ao desastre não é o mesmo ao trauma convencional
			- Maior bem para maior número de indivíduos
			- O gerenciamento de crise vem antes do atendimento ao paciente
			- Prontidão para emergências
		- Diferenciação de ocorrências
			- Incidentes com múltiplas vítimas
				- Recursos médicos utilizados, mas não sobrecarregados.
				- Capacidade maior do que número de vítimas e gravidade
			- Eventos com vítimas em massa
				- Sobrecarga
				- Interrupção dos serviços de saúde locais
				- Capacidade menor do que número e gravidade das vítimas
				- Demanda por recursos excede capacidade de reabastecimento
				- Princípios de prontidão e resposta
		- Abordagem
			- Todos os perigos - Abordagem única, estruturada, que pode ser adaptada para os mais diversos desastres.
			- Resposta
			  collapsed:: true
				- Busca e Salvamento
				- Triagem
				- Cuidado definitivo
				- Evacuação
		- Fases de manejo de desastres
			- Preparação - Planejamento e Treinamento
				- Preparação Comunitária
					- Envolver autoridades de saúde e de segurança pública
					- Grupos com necessidades especiais e minorias sofrem mais em desastres
					- Circunstâncias podem deixar instituições isoladas
					- Capacidade de surto = 20% a mais do que demanda habitual, levando em consideração insumos , equipamentos e pessoal
				- Preparação Hospitalar
					- Avaliação de risco
					- Desenvolver plano de desastres
					- Treinamento para situações de sobrecarga
					- Adaptação de pessoal para funções em um desastre. Se possível, mantendo-os no que já estão familiarizados.
					- Passos importantes
						- Providenciar meios de comunicação
						- Providenciar acondicionamento e armazenamento de recursos
						- Identificar prioridades nas 4 fases do desastre
						- Acordos pré-desastres para transporte de vítimas ou doentes internados
						- Planejar a mobilização de recursos
						- Treinar em gerenciamento de desastres
					- Procedimentos
						- Precauções de segurança, incluindo bloqueio hospitalar
						- Mobilize a equipe de comando
						- Notifique o pessoal em serviço e fora do serviço
						- Ativar plano de desastre
						- Preparar áreas de descontaminação, triagem e tratamento
						- Ativar equipes de desastre
						- Desenvolver planos de fluxo
						- Avaliar necessidades dos doentes internados
						- Verificar suprimentos e materiais e ter reserva para ao menos 72h
						- Estabelecer centro de informações públicas
						- Fornecer instruções ao pessoal, aos familiares e à comunidade
					- Exercícios em massa
						- Preparação
							- Definir áreas funcionais de responsabilidade
						- Gerenciamento de exercícios
							- Avaliação dos papéis funcionais do SCI
						- Tratamento do doente
							- Triagem e reanimação inicial
				- Planejamento pessoal
					- Planos de desastres familiares
			- Mitigação - Vulnerabilidade e perigos
			- Fases de Resposta - Emergência
			- Recuperação - Restauração
		- Sistema de comando de incidentes
			- Comando criado para coordenar todas as forças/organizações que atuam em um desastre.
			- Requisitos funcionais ao invés de títulos
			- Atividades principais
				- Comando de incidentes
					- Define objetivos e prioridades
					- Mantém a responsabilidade pelo desastre
				- Operações
					- Realiza operações para cumprir o plano de ação do incidente
					- Direciona os recursos, inclusive os humanos
				- Planejamento
					- Desenvolve o plano de ação do acidente
					- Coleta e avalia informações
				- Logística
					- Fornece recursos e trata da distribuição
				- Finanças/Administração
					- Monitora custos
					- Executa contratos
					- Mantém registros de pessoal
			- Identificação de pessoal-chave
			- Cada pessoa na estrutura de comando deve supervisionar apenas 3 a 7 pessoas
		- Busca e Resgate
			- Equipe especializada nisso
			- Especialistas em cuidados agudos
			- Especialistas técnicos conhecedores de materiais perigosos
			- Cães treinados
		- Triagem de vítimas de desastre
			- Constitui um desafio
			- Maior bem para o maior número de pessoas
			- Tratar primeiro doentes críticos com maiores chances de sobrevivência
			- Níveis de triagem em desastres
			  collapsed:: true
				- Nível 1 - Triagem médica de campo
					- Classificação rápida dos pacientes aonde estão
					- Agudos x Não-agudos
				- Nível 2 - Triagem médica
					- Classificação médica em local de coleta de vítimas ou hospital
					- Classificação por cores
				- Nível 3 - Triagem de evacuação
					- Atribui prioridades às vítimas para evacuação e transferência para instalações médicas
			- Erro de triagem
			  collapsed:: true
				- Triagem excessiva - Classificar pacientes não-críticos para cuidados urgentes, sobrecarregando o sistema.
				- Subtriagem - Deixar de classificar pacientes críticos para cuidados urgentes, atrasando seu atendimento prioritário.
		- Tratamento médico definitivo
			- Está além da estabilização do paciente, definindo conduta.
			- Tratamento ao trauma minimamente aceitável
			- Cirurgia de controle de danos
			- Resposta gradual e flexível, que melhora ao longo do tempo e conforme angarie recursos
		- Evacuação
			- Frequentemente necessária em situações de desastre
			- Avalie sempre as condições da evacuação
			- Evacuações por via aérea devem prever ambiente hipobárico
		- Descontaminação
			- Remoção de materiais perigosos, pessoas ou equipamentos contaminados
			- Realizar antes de pacientes entrarem no departamento de emergência
			- Remoção completa de roupas e adereços
			- Uso de EPI adequados
			- Zonas de descontaminação
			  collapsed:: true
				- Zona quente - área de contaminação, devendo ser isolada imediatamente para evitar mais vítimas
				- Zona morna - Área em que ocorre a descontaminação. Deve ser a favor do vento e acima da zona quente.
				- Zona fria - Área onde o doente já descontaminado vai para cuidados definitivos
			- Técnicas de descontaminação
			  collapsed:: true
				- Descontaminação bruta - Remover roupas, adereços e irrigar todo o corpo do doente com água
				- Descontaminação total - bem mais cara e demorada
			- Caso se descubra que as instalações foram contaminadas, implementar quarentena.
		- Tipos de ferimentos específicos
			- Lesões por explosão
			  collapsed:: true
				- Combinação de lesões de diferentes etiologias e mecanismos
				  collapsed:: true
					- Lesão primária - Efeitos diretos da onda de choque
					- Lesão secundária - lesões penetrantes por fragmentos ou objetos
					- Lesão terciária - lesões contusas pelo lançamento no ar e queda
					- Lesão quaternária - Todos os outros ferimentos como queimaduras, esmagamentos, inalações, infecções.
				- Fatores prognósticos
				  collapsed:: true
					- Proximidade do paciente à explosão
					- Magnitude
					- Ambiente em que ocorreu a explosão
					- Presença de colapso estrutural associado
					- Triagem das vítimas
					- Recursos disponíveis
			- Lesões e doenças químicas
			  collapsed:: true
				- Agentes
				  collapsed:: true
					- Nervosos
					  collapsed:: true
						- via percutânea ou inalação
						- Afetam sistema colinérgico, muscarínico ou nicotínico
						- Interrompem os mecanismos pelos quais os nervos se comunicam com músculos, glândulas ou outros nervos
						- Perda da consciência, convulsões, apneia e paralisia flácida
					- Asfixiantes
					  collapsed:: true
						- Interferem na capacidade de realizar metabolismo aeróbico
						- Morte em poucos minutos
						- Perda de consciência, convulsões, apneia e parada cardíaca
					- Pulmonares
					  collapsed:: true
						- Causam edema pulmonar
					- Vesicantes
					  collapsed:: true
						- Causam eritema e vesículas na pele, lesões oculares e em vias aéreas
					- Antimotim lacrimatórios
					  collapsed:: true
						- causam ardor nos olhos e lacrimejamento, desconforto respiratório e broncoespasmo
				- Tratamento
				  collapsed:: true
					- Nervosos
						...
						- Pralidoxima - Efeitos nicotínicos - administração precoce
						- Diazepam para convulsões
						- Sistemas prontos de atropina + pralidoxima como DuoDote e Kit Mark I
					- Asfixiantes
						- Ventilação com oxigênio
						- Cianeto ou hidroxocobalamina IV
					- Pulmonares
						- Restrição de exposição
						- Oxigênio e ventilação
						- Não fazer nenhuma atividade física
					- Vesicantes
						- Descontaminação
						- Manejo sintomático de lesões
					- Antimotim
						- Manejo sintomático
						- Irrigação salina nos olhos
						- água fria e detergente para a pele
						- Cloroacetofenona e Clorobenzilideno malononitrilo
				- Toxidromes
				  collapsed:: true
					- SLUDGE - tratar com atropina
						- Salivação
						- Lacrimejamento
						- Urina
						- Defecação
					...
					- DUMBELS - Tratar com atropina
						...
						- LacrimejamentoSal
						- Salivação
					- MTW(t)HF^ - Efeitos nicotínicos
						- Midríase
						- Taquicardia
						- W Fraqueza muscular
						- (t)H Hipertensão, hiperglicemia
						- Fasciculações
			- Lesões radioativas
				- Tipos de radiação
				  collapsed:: true
					- Radiação eletromagnética - destroem tecidos, mas não deixam radioatividade residual
					- Radiação de partículas - não penetram tão facilmente nos tecidos, mas continuam irradiando
				- Gerenciamento de emergência de vítimas de radiação
				  collapsed:: true
					- Dano tecidual focal, necrose e síndrome de radiação aguda
					- Triagem convencional
					- Descontaminação antes, durante e depois da estabilização
					- Detectores de radiação têm seus limites
					- Cirurgia de emergência
					- Comprimidos de iodo só agem contra iodo radioativo na tireoide, sem ação para outros agentes
				- Cenários de ameaçaradioativa
				  collapsed:: true
					- Detonações nucleares
					  collapsed:: true
						- Lesões pro explosão
						- Lesões térmicas por flash e chama
						- Lesões por radiação por irradiação de ondas e precipitação de detritos radioativos
		...
		- Armadilhas
			...
			- Erros de triagem
			- Recursos em excesso
	- E - ATLS e Equipe de Trauma -  Manejo de Recursos
	  collapsed:: true
		- Configuração da equipe de trauma
			- Líder de equipe
			- Atendente da via aérea
			- Assistente de via aérea
			- Segundo atendente
			- Dois enfermeiros
			- Pessoal adicional sempre que possivel
				- secretário
				- Maqueiros, técnicos e auxiliares de enfermagem
				- Técnicos de radiologias
				- Especialistas médicos
		- Equipe de trauma bem sucedida
			- Líder com experiência no ATLS e no direcionamento da equipe
			- Comunicação eficaz
			- Todos os membros conhecem bem o caso e o que foi feito
			- Passagem adequada do caso
			- Respeito e coesão
			- Debriefing pós-ação
		- Papéis e responsabilidades do líder de equipe
			- Preparar a equipe
			- Recebendo o doente
				- Recepção do caso adequadaT
			...
			- Direcionando a equipe e respondendo à informação
				- Idealmente o líder não se envolve nos procedimentos clínicos
				- Coordena a resposta e pensa
			- Discussão com a equipe
				...
				- Perguntas norteadoras
					...
					- Há algumas ações que devemos fazer antes da próxima vez?
			- Falando com acompanhantes do doente
				- Aguarde até que o doente esteja estável ou nomeie outro membro da equipe para comunicar
				- Colete informações relevantes
				- Treinamento e experiência em comunicação de más notícias
		- Liderança efetiva
			- Qualidades e comportamentos de uma liderança eficaz
				- Pensamento sistemático
				- Tem os membros da equipe como parceiros
				- Humildade
			- Cultura e clima
				- Encorajar feedback e melhorias
		- Funções e responsabilidades dos membros de equipe
			- Intregração da equipe
			- Acolhimento a novatos na equipe
			- Não agir isoladamente
			- Esteja seguro com suas competências
			- Peça ajuda se necessitar
			- Se não concordar, expresse razoável e calmamente suas preocupações
			- Confie nos outros membros
		- Responsabilidades individuais
			- Esteja ciente de suas funções, dos recursos disponíveis e responsabilidades
			- Cuide da sua própria segurança
			- Domine o caso clínico do paciente
			- Comunicação em alça fechada
			- Comunicação de dificuldades
			- Envolver o líder nas discussões
				- Não resumi por motivos de muita repetição
			- Comunicação
				- Direta e bidirecional
				- Alça fechada
				- Tom de voz normal
				- Aproveite as pausas
				- Evite discussão na frente de pacientes conscientes
				- Resolva discussões envolvendo protocolos e médicos mais experientes
	- F - Cenários de Triagem
	  collapsed:: true
		- Triagem é o processo de priorizar doentes em eventos de vítimas em massa
		- Resgate seguro é a primeira prioridade
			- A segurança da equipe está acima de qualquer outra coisa
			- O socorrista é um recurso valioso e escasso e deve se tratar como tal.
			- O socorrista que se submete a uma cena perigosa está correndo o risco de deixar a situação ainda mais complicada sendo apenas um traumatizado a mais.
			- O resgate só começa quando o socorrista tem certeza de que a cena está segura
		- Fazer o melhor para a maioria dos doentes com os recursos disponíveis
			- Acidentes com vítimas em massa exigem triagem, já que o resgate de todos excede a capacidade.
		- Tomar decisões em tempo hábil
			- Utilize o ABCDE também para priorizar os doentes
		- Preparar triagem para ocorrer em múltiplos níveis
			- A triagem deve ser repetida continuamente e em cada nível de atenção, não somente na cena.
		- Conhecer os recursos disponíveis
			- Esteja atento às modificações de recursos
		- Planejar e ensaiar respostas
			- Treine situações corriqueiras ou com grande risco de acontecer naquele local
		- Determinar os tipos e categorias de triagem com antecedência
			- Triagem com base em cores
				- Vermelho - Intervenção imediata por risco de morte
				- Amarelo - Intervenção imediata por risco de deterioração para vermelho ou perda de membros
				- Verde - Lesões que não ameaçam a vida
				- Cinza - Expectantes. Pacientes tão graves que, em evento de massa, provavelmente têm prognóstico muito reservado. Cuidado deve ser paliativo.
				- Preto - Óbito
			- Pacientes cujo estado seja bom podem ser recrutados para auxiliar no socorro de si mesmos e de outros.
		- Triagem contínua
			- Refazer triagem conforme evolução clínica e em cada nível de cuidado
			- Reavaliar triagem caso recursos aumentem ou diminuam, bem como conforme forem sendo realizados os atendimentos mais urgentes.
	- G - Estações práticas
	  collapsed:: true
		- A
		- B
